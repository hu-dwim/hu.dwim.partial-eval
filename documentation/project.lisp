...
(def method make-project-tab-pages ((component project/detail/inspector) (project (eql (find-project :hu.dwim.partial-eval))))
  (append (call-next-method)
          (list (tab-page/widget (:selector (icon switch-to-tab-page :label "Install guide"))
                ...
                (tab-page/widget (:selector (icon switch-to-tab-page :label "Adventures"))
                  (make-value-inspector (find-book 'adventures)))
                (tab-page/widget (:selector (icon switch-to-tab-page :label "Package"))
